...
/*
AddMutex использует мьютекс для синхронизации доступа к переменной counter.

AddAtomic использует атомарную операцию AddInt64 для увеличения значения counter.
*/
